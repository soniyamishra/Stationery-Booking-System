...
//	  }
	 ...
	 public int insert(Review review)  
	  {	 int id = review.getProduct().getProductId();
	     ...
	     {
	    	 if(productBooking.get(i).getApprovalStatus().equals("CONFIRM"))
	    	 {
	    		 reviewApplicable=1;
...
//	@UpdateTimestamp
	 ...
	 public int updateCommentAndRating(Review review) {
			...
			long inputUserId=review.getUser().getId();
			long userId=reviewUpdate.getUser().getId();
	 ...
	 public Review updateReview2(Review review) {
